...
img1=ImageTk.PhotoImage(Image.open("images/img1.jpg"))#make sure that you have a photo
#in you current folder that you are working with
img2=ImageTk.PhotoImage(Image.open("images/img2.jpg"))
img3=ImageTk.PhotoImage(Image.open("images/img1.jpg"))
img4=ImageTk.PhotoImage(Image.open("images/img2.jpg"))
